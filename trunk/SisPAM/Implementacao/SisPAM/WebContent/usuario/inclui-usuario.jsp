...
<s:form id="formPerfil" action="usuarioAction!salvarUsuario.action">
	...
	<s:if
		...
		<table border="0" width="100%" class="tabela_moldura" cellpadding="3"
			cellspacing="4">
			<tr>
				<td><label class="label" >Nome:</label></td><td><s:textfield theme="simple" name="usuario.nome"
					size="60" maxlength="60" /></td>				
				<td><label class="label" >CPF:</label></td><td><s:textfield theme="simple"
					name="usuario.cpf" size="12" maxlength="11" /></td>
			</tr>
			<tr>
				<td><label class="label" >RG:</label></td><td><s:textfield theme="simple" name="usuario.rg"
					size="15" maxlength="15" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<label class="label" >Expedidor:&nbsp;&nbsp;</label><s:textfield
					theme="simple" name="usuario.expedidorRg" size="15" maxlength="15" />
				
				<td><label class="label" >Sexo:</label></td><td><s:select list="sexos" theme="simple"
					name="usuario.sexo" headerKey="0" headerValue="" listKey="sigla" /></td>				
			</tr>
			<tr>
				<td><label class="label" >Endereço:</label></td><td><s:textfield theme="simple"
					name="usuario.endereco" size="60" maxlength="60" /></td>
				<td><label class="label" >Cidade:</label></td><td><s:textfield
			...
			<tr>
				...
				<td><label class="label" >DDD:</label></td><td><s:textfield theme="simple" name="usuario.ddd" size="3"
					maxlength="3" />&nbsp;&nbsp;
				<label class="label" >Tel:&nbsp;&nbsp;</label><s:textfield theme="simple"
					name="usuario.telefone" size="8" maxlength="8" /></td>				
			</tr>
			<tr>
				<td><label class="label" >E-mail:</label></td><td><s:textfield theme="simple"
					name="usuario.email" size="30" maxlength="30" /></td>				
				<td><label class="label" >Senha:</label></td><td><s:password theme="simple"
					name="usuario.senha" maxlength="25" size="25" /></td>

			</tr>
			<tr>
				<s:submit align="center" value="Salvar" cssClass="button" />
			</tr>
		</table>
	</s:if>
	<s:elseif test="codigoPerfilSelecionado == 3">
		<table border="0" width="100%" class="tabela_moldura" cellpadding="3"
			...
			<tr>
				...
				<td><label class="label" >CRM:</label></td><td><s:textfield theme="simple" name="medico.crm"
					size="7" maxlength="7" /></td>
			
			<s:submit align="center" value="Salvar" cssClass="botao_salvar" />
		</table>
	</s:elseif>
